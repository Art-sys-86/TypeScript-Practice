...
const historyLog = document.getElementById('historyLog') as HTMLOutputElement;
...
historyLog: string;
constructor(inputElement: HTMLInputElement, historyLog:string) {
...
cal(first: number, operator: string, second: number):number | string{
...
appendDigits(value:string, maxLength = 15){
...
chooseOperation(operationValue:string){
